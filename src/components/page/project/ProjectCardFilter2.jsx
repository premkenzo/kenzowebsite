      ...
      <div className="row">
        <div className="col-12">
          <ul className="isotope-menu">
            {/* <li
              onClick={() => {
                dispatch({ type: "dataAll" });
                window.location.href = `${process.env.PUBLIC_URL}/projects`; // Redirect to the specified path
              }}
...
export default ProjectCardFilter2;
